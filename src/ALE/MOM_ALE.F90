...
subroutine ALE_main( G, GV, US, h, u, v, tv, Reg, CS, OBC, dt, frac_shelf_h)
  ...
  if (ice_shelf) then
    call regridding_main( CS%remapCS, CS%regridCS, G, GV, h, tv, h_new, dzRegrid, frac_shelf_h, dt=dt, u=u, v=v)
  else
...
subroutine ALE_regrid_accelerated(CS, G, GV, h, tv, n, u, v, OBC, Reg, dt, dzRegrid, initial)
  ...
  do k = 1, n
    ...
    ! generate new grid
    call regridding_main(cs%remapCS, CS%regridCS, G, GV, h_loc, tv_local, h, dzInterface, dt=dt, u=u, v=v)
